...
转自：[Java中的Collection和Map详解](http://developer.51cto.com/art/200906/131668.htm)

在进行Java开发时，JDK已经为我们提供了一系列相应的类来实现如线性表，链表，哈希表基本的数据结构。本文向您介绍Collection和Map这两个类。
